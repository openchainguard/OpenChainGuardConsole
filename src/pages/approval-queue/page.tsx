              ...
              <tbody className="divide-y">
                {escalated.map((tx) => (
                  <tr key={tx.id} className="hover:bg-muted/20 transition-colors">
                    ...
                    <td className="px-5 py-3 text-sm font-medium text-foreground whitespace-nowrap">{tx.agentName}</td>
                    <td className="px-5 py-3 font-mono text-xs text-muted-foreground whitespace-nowrap">
                      {truncateAddress(tx.destination)}
                    </td>
                    <td className="px-5 py-3 text-sm font-medium text-foreground whitespace-nowrap">{formatUSDC(tx.amount)}</td>
